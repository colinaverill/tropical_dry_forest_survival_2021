...
dat <- d$all.dat[,c('spp','phase1_surv_yr2','phase1_RGR_yr2','bg.PC1','bg.PC2','bg.PC3','ag.PC1','ag.PC2','ag.PC3')]
...
#save model list.
mod.list <- list(m.ag, m.bg, m.rgr, m.ag_rgr, m.bg_rgr)
mod.lab  <-    c('m.ag','m.bg','m.rgr','m.rgr_ag','m.rgr_bg')
